<!-- PUT THIS FIELD IN TEMPLATE DIRECTORY OF CONTAO -->
 ...
 <a class="navbar-brand" href="#">Mega Dropdown</a>-->
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mx-auto">
      ...
      <li class="nav-item dropdown megamenu">
        <a class="nav-link dropdown-toggle" href="#" id="megamenu2" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
          Institute
        </a>
        <div class="dropdown-menu" aria-labelledby="megamenu2" id="megamenu22">
          <div class="container">
             <div class="row bg-black rounded-0 ">
              <div class="col">
                <div class="text-uppercase text-white subtit">INSTITUTE</div>
                <ul class="nav flex-column">
                <li class="nav-item">
              ...
              <!-- /.col-md-4  -->
              <div class="col">
                  <div class="text-uppercase text-white subtit">PROJECTS</div>
                <ul class="nav flex-column">
                <li class="nav-item">
                  <a class="nav-link " href="#">SOURCE BOOK</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" href="#">DATA REDUCTION</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" href="#">WOLF SERIES</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" href="#">GROUP NUMBER</a>
                </li>
              </ul>
              </div>
            ...
            <div class="row">
              <div class="col">
               <div class="text-uppercase text-white subtit">DATA</div>
                ...
                <li class="nav-item"><a class="nav-link" href="wolfreview.html">REVIEW</a></li>
              </ul>
              </div>
              <!-- /.col-md-4  -->
              <div class="col">
